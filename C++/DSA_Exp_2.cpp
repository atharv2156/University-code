...
void info::display()
{
    ...
    else
    {
        ...
        {
            cout << " \n"
                 << temp->mis << " " << temp->rollno << " " << temp->name;
            temp = temp->next;
        }
        cout << " " << temp->mis << " " << temp->rollno << " " << temp->name;
    }
}
void info::delm()
{
    int m, f = 0;
    cout << "\n enter the mis no. of student whose data you want to delete";
    cin >> m;
    temp = head;
    while (temp->next != NULL)
    {
...
void info::concat()
{
    ...
    temp1->next = head2;
    temp2 = head1;
    cout << " mis rolln0 NAME \n";
    while (temp2->next != NULL)
    {

        cout << "\n " << temp2->mis << " " << temp2->rollno << " " << temp2->name << "\n";
        ;
        temp2 = temp2->next;
    }
    cout << "\n " << temp2->mis << " " << temp2->rollno << " " << temp2->name << "\n";
